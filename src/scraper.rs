...
impl Scraper {
    pub fn new(spider: Box<dyn Spider>, spider_request_tx: mpsc::Sender<Request>) -> Self {
        Self {
            spider,
            spider_output_processor: SpiderOutputProcessor::new(spider_request_tx),
        }
    }
...
impl SpiderOutputProcessor {
    ...
    pub fn new(spider_request_tx: mpsc::Sender<Request>) -> Self {
        ...
        spider_output_processor.start(spider_output_rx, spider_request_tx);
